...
const styles = StyleSheet.create({
  ...
  rarityRow: { paddingHorizontal: 12, paddingTop: 4, paddingBottom: 10, gap: 6, flexDirection: 'row' },
  rarityBtn: { padding: '6px 12px', borderRadius: 20, backgroundColor: '#16213e', border: '1px solid #2a2a4a' },
  ...
  translatedNote: { color: '#888', fontSize: 11, paddingHorizontal: 14, paddingTop: 4, paddingBottom: 2 },
  translatedWord: { color: '#E63F00', fontFamily: fonts.bold },
  resultCount: { color: '#666', fontSize: 12, paddingHorizontal: 14, paddingBottom: 6 },
  grid: { padding: 8 },
